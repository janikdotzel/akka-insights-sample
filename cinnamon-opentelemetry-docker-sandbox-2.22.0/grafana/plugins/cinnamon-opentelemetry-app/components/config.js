...
System.register(['lodash'], function (_export, _context) {
    ...
    var _, _createClass, CinnamonOpenTelemetryAppConfigCtrl;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('CinnamonOpenTelemetryAppConfigCtrl', CinnamonOpenTelemetryAppConfigCtrl = function () {
                function CinnamonOpenTelemetryAppConfigCtrl(backendSrv) {
                    var _this = this;

                    _classCallCheck(this, CinnamonOpenTelemetryAppConfigCtrl);

                    this.backendSrv = backendSrv;
                    this.datasourceName = 'Cinnamon Prometheus (via OpenTelemetry)';
                    ...
                    backendSrv.get('/public/plugins/cinnamon-opentelemetry-app/plugin.json').then(function (data) {
                        _this.dashboards = _.filter(data.includes, { type: 'dashboard' });
                    });
                }

                _createClass(CinnamonOpenTelemetryAppConfigCtrl, [{
                    key: 'preUpdate',
                ...
                return CinnamonOpenTelemetryAppConfigCtrl;
            }());

            _export('CinnamonOpenTelemetryAppConfigCtrl', CinnamonOpenTelemetryAppConfigCtrl);

            CinnamonOpenTelemetryAppConfigCtrl.templateUrl = 'components/config.html';
        }
    };
});
